...
app.post(`${ config.baseUrl }sendMail`, cors(corsOptions), function(req, res, next) {
  ...
  async function sendMail() {
      ...
      let info = await transporter.sendMail({
        ...
        html: "<b>Neuer Upload verfügbar.</b><br>Name: " + JSON.stringify(data.name) + "<br> E-Mail: " + JSON.stringify(data.email) + "<br>Betreff: " + JSON.stringify(data.topic) + "<br> Nachricht: " + JSON.stringify(data.message)  + "<br> Downloadlink: " + config.baseUrl + JSON.stringify(data.sid) + "<br> Dateien: " + JSON.stringify(data.files), // html body
      });
