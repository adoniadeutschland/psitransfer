...
app.post(`${config.baseUrl}sendMail`, cors(corsOptions), function (req, res, next) {
  ...
  let htmlcontent = "<b>Neuer Upload verfügbar:</b>" + "<br>Betreff: " + data.topic?.toString()
  ...
  async function sendMail() {
    try {
      ...
      let receivers = (process.env.DEV == 'TRUE') ? "fabian.giering@adonia.de" : "medienupload@adonia.de";
      let info = await transporter.sendMail({
        from: '"Medienupload Adonia" <noreply@adonia.de>', // sender address
