...
app.post(`${config.baseUrl}sendMail`, cors(corsOptions), function (req, res, next) {
  ...
  async function sendMail() {
    try {
      ...
      : (data.topic == "Live-Band-Bewerbung") ? process.env.MAIL_TO_TOPIC_APPLICATION
      : (data.topic == "Führerschein") ? process.env.MAIL_TO_TOPIC_DRIVERLICENSE
      : (data.topic == "Konzertsaal Informationen") ? process.env.MAIL_TO_TOPIC_CONCERTHALL
      : (data.topic == "Erinnerungsfilm") ? process.env.MAIL_TO_TOPIC_SOUVENIRMOVIE
      : (data.topic == "Social Media") ? process.env.MAIL_TO_TOPIC_SOCIALMEDIA
      : (data.topic == "Sonstiges") ? process.env.MAIL_TO_TOPIC_MISCELLANEOUS
      : process.env.MAIL_TO;
